...
- Guided pinball detours should render the channel and water as rounded centerline strokes, avoid non-collision effects at transitions, and expose monotonic race progress so the camera follows the actual leader even while the route rises; verify containment, effects, leader selection, and camera deltas frame by frame.
