...
- Guided pinball detours should render the channel and water as rounded centerline strokes instead of offset polygons, avoid non-collision effects at transitions, retain one camera target with hysteresis, and verify containment, motion, effects, target changes, and camera deltas frame by frame.
