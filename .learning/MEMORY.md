...
- Guided pinball branches need disjoint entry ranges, gap-free full-width junctions, constant-width bodies where required, non-crossing centerlines, and shared monotonic progress; verify both routes are entered, junction coverage, containment, effects, leader selection, and camera deltas frame by frame.
