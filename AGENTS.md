...
- 혼돈 공장 중간은 왼쪽의 폭이 줄지 않는 수중 상승 경로와 오른쪽의 구불구불한 일반 하강 경로로 나뉘며, 진입 위치에 따라 서로 다른 속도와 거리의 길을 지나 승패가 달라진다.
...
- 기본 네온 보드는 중앙 핀과 양옆 벽 핀을 같은 행과 같은 교차 각도로 맞춰 규칙적으로 유지하며, 공이 양옆 빈 통로로 곧장 떨어지지 않게 한다.
